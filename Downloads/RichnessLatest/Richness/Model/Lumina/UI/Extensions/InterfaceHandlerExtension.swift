...
extension LuminaViewController {
    ...
    func updateUI(orientation: UIInterfaceOrientation) {
        ...
        self.previewLayer.frame = CGRect(x: 0, y: 60, width: self.view.frame.size.width, height:  self.view.frame.size.height - 250.0) //self.view.bounds

        let uppersingleLine = UIView()
        uppersingleLine.frame =  CGRect(x: 0, y: self.view.frame.origin.y + self.previewLayer.frame.origin.y, width: self.view.frame.size.width, height: 3)
        uppersingleLine.backgroundColor = #colorLiteral(red: 0.8164560199, green: 0.7133601308, blue: 0.52625525, alpha: 1)
        self.view.addSubview(uppersingleLine)

        let singleLine = UIView()
        singleLine.frame =  CGRect(x: 0, y: self.previewLayer.frame.origin.y + self.previewLayer.frame.size.height , width: self.view.frame.size.width, height: 3)
        singleLine.backgroundColor = #colorLiteral(red: 0.8164560199, green: 0.7133601308, blue: 0.52625525, alpha: 1)
...
//        self.textPromptView.frame = CGRect(x: 0 , y: 50 , width: self.view.frame.size.width, height: 2)
//        self.textPromptView.backgroundColor = #colorLiteral(red: 0.8164560199, green: 0.7133601308, blue: 0.52625525, alpha: 1)
