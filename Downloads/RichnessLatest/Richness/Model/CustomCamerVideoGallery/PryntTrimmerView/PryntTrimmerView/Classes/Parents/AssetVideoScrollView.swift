...
class AssetVideoScrollView: UIScrollView {
    ...
    private var widthConstraint1: NSLayoutConstraint?
    ...
    private func setupSubviews() {
        ...
        widthConstraint1 = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 1.0)
    ...
    private func setContentSize(for asset: AVAsset) -> CGSize {
        ...
        widthConstraint1?.isActive = false
        widthConstraint1 = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: contentWidthFactor)
        widthConstraint1?.isActive = true
        layoutIfNeeded()
