...
@IBDesignable public class TrimmerView: AVAssetTimeSelector {
    ...
    public var leftConstraint1: NSLayoutConstraint?
    public var rightConstraint1: NSLayoutConstraint?
    ...
    private func setupTrimmerView() {
        ...
        leftConstraint1 = trimView.leftAnchor.constraint(equalTo: leftAnchor)
        rightConstraint1 = trimView.rightAnchor.constraint(equalTo: rightAnchor)
        leftConstraint1?.isActive = true
        rightConstraint1?.isActive = true
    }
    ...
    @objc func handlePanGesture(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            if isLeftGesture {
                currentLeftConstraint = leftConstraint1!.constant
            } else {
                currentRightConstraint = rightConstraint1!.constant
            }
    ...
    private func updateLeftConstraint(with translation: CGPoint) {
        ...
        leftConstraint1?.constant = newConstraint
    }
    ...
    private func updateRightConstraint(with translation: CGPoint) {
        ...
        rightConstraint1?.constant = newConstraint
    }
