...
class YPAlbumVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedStringKey.foregroundColor : #colorLiteral(red: 0.8164560199, green: 0.7133601308, blue: 0.52625525, alpha: 1) ] // Title color
    ...
    func setUpTableView() {
        ...
        v.tableView.backgroundColor = .black
...
extension YPAlbumVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cell = tableView.dequeueReusableCell(withIdentifier: "AlbumCell", for: indexPath) as? YPAlbumCell {
            ...
            cell.thumbnail.backgroundColor = .black
