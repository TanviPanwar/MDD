...
public struct YPImagePickerConfiguration {
    ...
    public var bottomMenuItemSelectedColour = #colorLiteral(red: 0.8164560199, green: 0.7133601308, blue: 0.52625525, alpha: 1)  //UIColor(r: 38, g: 38, b: 38)
    
    /// Defines the text colour to be shown when a bottom option is unselected
    public var bottomMenuItemUnSelectedColour = #colorLiteral(red: 0.8155146241, green: 0.7583848238, blue: 0.6388469338, alpha: 1) //UIColor(r: 153, g: 153, b: 153)
