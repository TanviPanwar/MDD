...
public struct YPIcons {
    ...
    public var loopIcon: UIImage = imageFromBundle("icon3")
    ...
    public var capturePhotoImage: UIImage = imageFromBundle("icon1")
    public var captureVideoImage: UIImage = imageFromBundle("icon1")
    ...
    public var crossIcon: UIImage = imageFromBundle("icon4")
    //public var icon_check: UIImage = imageFromBundle("icon_check")
}
