...
class UserProfileCell: UITableViewCell
{
    ...
    @IBOutlet weak var followUnfollowBtn: GradientButton!
    ...
    public var onFolllowUnfollowButtonTapped : (() ->Void)? = nil
    ...
    @IBAction func onFollowUnfollowBtnTapped(_ sender: UIButton) {

        onFolllowUnfollowButtonTapped!()
    }
