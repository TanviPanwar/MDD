...
open class SideMenuController: UIViewController {
    ...
    @objc private func handlePanGesture(_ pan: UIPanGestureRecognizer) {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad {
            ...
            menuWidth = preferences.basic.menuWidth1
            
        }
        
        else {
               menuWidth = preferences.basic.menuWidth
        ...
        case .above, .sideBySide:
            ...
            if visibility {
                ...
                if UIDevice.current.userInterfaceIdiom == .pad {
                   ...
                   baseFrame.origin.x = preferences.basic.menuWidth1 - baseFrame.width
        ...
        case .under, .sideBySide:
            ...
            if visibility {
                ...
                if UIDevice.current.userInterfaceIdiom == .pad {
                    ...
                    baseFrame.origin.x =  preferences.basic.menuWidth1 * factor
